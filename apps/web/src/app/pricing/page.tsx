...
export default function PricingPage() {
  ...
  return (
    <PageTransition>
      <div className="cb-page !max-w-5xl py-12 md:py-16">
        <motion.div
        ...
        >
          ...
          <div className="grid gap-6 md:grid-cols-3">
            ...
            <motion.div variants={fadeUp}>
              <div className="cb-section surface-card-hover h-full p-6">
            ...
            {/* Monthly Pro */}
            <motion.div variants={fadeUp}>
              <div className="cb-section surface-card-hover h-full border-primary/30 p-6">
            ...
            {/* Annual Pro */}
            <motion.div variants={fadeUp}>
              <div className="cb-section surface-card-hover relative h-full border-primary/20 p-6">
          ...
          {/* Footer Note */}
          <motion.div variants={fadeUp}>
            <div className="cb-section animate-soft-fade p-5 text-sm text-muted-foreground">
              <p>
